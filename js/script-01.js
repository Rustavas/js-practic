...
// example from Anton's lecture

// напиши скрипт для отображения часов и минут в консоли
// браузера в выгляде строки в формате `"14 ч. 26 м."`.
// Если значение переменной `minutes` равняется `0`,
...
// let timestring;
// if (minuts > 0) {
//   console.log(`${hours} ч. ${minuts} мин.`);
// } else {
//   console.log(`${hours} ч.`);
// }
// ================================================
...
// message.split(",");
// console.log(message);
// console.log(message.length * price)
